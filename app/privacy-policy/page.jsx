  ...
  return (
    ...
    >
      ...
      <p>
        ...
        information such as your name, email address, phone number and message
        details.
      </p>

      <h2>3. How inquiries are handled</h2>
      <p>
        Forms on this website are email-only. Form submissions are sent by email
        to RORUM. Personal inquiries are not stored in Sanity, and no inquiry
        database is used in this simplified setup.
      </p>
      ...
      <ul>
        ...
        <li>
          RORUM&apos;s legitimate interest in responding to inquiries and
      ...
      <h2>7. Sanity Free</h2>
      <p>
        Sanity Free is used only for public website content. Personal inquiries
        and form submissions are not stored in Sanity.
      </p>

      <h2>8. External providers</h2>
      <p>
        Billetto is used as an external ticket provider for selected event
        ticket links. If you use Billetto, their own privacy policy and terms
        apply.
      </p>
      <p>
        The Contact page may include a Google Maps iframe. Google may process
        data when the map is loaded.
      </p>

      <h2>9. Analytics and tracking</h2>
      <p>
        Google Analytics and Meta Pixel are not intentionally used by default on
        this simplified website. RORUM does not intentionally use marketing
        tracking by default.
      </p>

      <h2>10. How long information is kept</h2>
      <p>
        Email inquiries may be kept for as long as needed to respond to your
        request and manage the conversation. You can ask RORUM to delete your
        inquiry email where possible.
      </p>

      <h2>11. Your rights</h2>
      <p>
        You may contact RORUM to request access to your personal data,
        correction, deletion, restriction of processing, or to object to
        processing where applicable.
      </p>
      <p>
        If processing is based on consent, you may withdraw your consent at any
        time.
      </p>
      <p>
