...
export const metadata = {
    title: "Terms | RORUM",
    description: "Terms for using the RORUM website, submitting inquiries and following external ticket links."
};
...
export default function TermsPage() {
    return (
      <LegalPage title="Terms" subtitle="Terms for using the RORUM website, submitting inquiries and following external ticket links.">
            ...
            <p>Forms on this website are email-only. Submitting a form sends your inquiry to RORUM by email. Form submissions are not stored in Sanity, and no inquiry database is used in this simplified setup.</p>

            <h2>4. Bookings and tickets</h2>
            <p>Submitting an inquiry does not create a confirmed booking. Details such as availability, pricing and final arrangements are confirmed separately. Event ticket purchases may be handled through Billetto, which is an external ticket provider.</p>

            <h2>5. External links and services</h2>
            <p>This website may link to external services, including Billetto, Google Maps and social media platforms. RORUM is not responsible for the content, policies or technical behavior of external websites.</p>

            <h2>6. Website content</h2>
            <p>All text, images, design elements and website content belong to RORUM or are used with permission. You may not copy, reuse or distribute website content without permission from RORUM.</p>
