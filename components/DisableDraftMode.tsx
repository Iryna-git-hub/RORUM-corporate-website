...
export function DisableDraftMode() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 left-4 z-[9999] inline-flex items-center gap-2 rounded-full bg-dark-green px-4 py-2 text-[12px] font-extrabold uppercase tracking-[0.06em] text-white shadow-[0_8px_24px_rgba(0,0,0,0.25)] no-underline hover:bg-red"
