...
export const pages = [
    { href: "/", title: "Home", description: "RORUM is a warm Copenhagen space for meaningful events, private meetings and community gatherings." },
    ...
    { href: "/private-meetings", title: "Private Meetings", description: "Plan private meetings, team sessions and intimate gatherings at RORUM." },
...
const featuredEvents = [
    {
        ...
        whatToExpect: ["Small group format", "Seasonal shared dinner", "Warm RORUM atmosphere", "Facilitated introductions", "Time for conversation"],
        practicalDetails: [
            { label: "Address", value: "Buermistersgade 26, 1 th, Copenhagen" },
    ...
    },
    {
        ...
        whatToExpect: ["Hands-on guidance", "Seasonal materials", "Coffee, tea and a sweet pause", "Small-group format", "Practical setup ideas"],
        practicalDetails: [
            { label: "Address", value: "Buermistersgade 26, 1 th, Copenhagen" },
            { label: "Arrival", value: "Please arrive 5-10 minutes before the event begins." },
    ...
    },
    {
        ...
        whatToExpect: ["Coffee and tea", "Guided check-in", "Focused work prompts", "Small-group reflection", "Calm morning rhythm"],
        practicalDetails: [
            { label: "Address", value: "Buermistersgade 26, 1 th, Copenhagen" },
            { label: "Arrival", value: "Please arrive 5-10 minutes before the event begins." },
...
const eventAdditions = [
    { slug: "soft-launch-breakfast", title: "Soft Launch Breakfast", date: "2026-05-05", time: "09:00-11:00", category: "Breakfast", price: "165 kr.", ticketsLeft: 6, image: "/images/catering/catering-1.png" },
    { slug: "candlelit-listening-room", title: "Candlelit Listening Room", date: "2026-05-07", time: "19:00-21:00", category: "Culture", price: "185 kr.", ticketsLeft: 4, image: "/images/space/space-2.png" },
    { slug: "summer-table-lab", title: "Summer Table Lab", date: "2026-05-12", time: "17:30-20:00", category: "Workshop", price: "345 kr.", ticketsLeft: 9, image: "/images/decoration/decoration-1.png" },
    { slug: "creative-hosts-circle", title: "Creative Hosts Circle", date: "2026-05-15", time: "18:00-20:00", category: "Community", price: "95 kr.", ticketsLeft: 12, image: "/images/events/meeting.png" },
    { slug: "nordic-brunch-club", title: "Nordic Brunch Club", date: "2026-05-17", time: "10:00-12:30", category: "Food", price: "245 kr.", ticketsLeft: 5, image: "/images/catering/catering-2.png" },
    { slug: "tiny-talks-evening", title: "Tiny Talks Evening", date: "2026-05-21", time: "18:30-21:00", category: "Talks", price: "145 kr.", ticketsLeft: 7, image: "/images/events/workshop.png" },
    { slug: "floral-mood-workshop", title: "Floral Mood Workshop", date: "2026-05-24", time: "17:00-19:30", category: "Styling", price: "375 kr.", ticketsLeft: 3, image: "/images/decoration/decoration-2.png" },
    { slug: "independent-work-morning", title: "Independent Work Morning", date: "2026-05-28", time: "09:00-11:30", category: "Salon", price: "115 kr.", ticketsLeft: 11, image: "/images/space/space-1.png" },
    { slug: "seasonal-supper-preview", title: "Seasonal Supper Preview", date: "2026-05-31", time: "18:30-21:30", category: "Dinner", price: "325 kr.", ticketsLeft: 8, image: "/images/catering/catering-1.png" },
    { slug: "community-reset-night", title: "Community Reset Night", date: "2026-06-04", time: "18:00-20:30", category: "Community", price: "135 kr.", ticketsLeft: 14, image: "/images/hero.jpg" }
];
const expandedEvents = eventAdditions.map((event) => ({
    ...
    included: ["Hosted arrival", "Coffee, tea or seasonal drink", "Small-group format", "Room setup by RORUM"],
    whatToExpect: ["Small group format", "Guided experience", "Warm RORUM atmosphere", "Tea & refreshments", "Time for conversation"],
    practicalDetails: [
        { label: "Address", value: "Buermistersgade 26, 1 th, Copenhagen" },
        { label: "Arrival", value: "Please arrive 5-10 minutes before the event begins." },
    ...
    ticketUrl: "https://billetto.dk/",
    calendarUrl: "https://calendar.google.com/",
    waitlistUrl: `mailto:hello@rorum.dk?subject=${encodeURIComponent(`${event.title} waitlist`)}`,
    isSoldOut: false,
    relatedEventSlugs: ["copenhagen-makers-dinner", "botanical-table-styling-workshop"]
}));
...
export const packages = {
    host: [
        { title: "Single Session", price: "From 1,800 kr.", items: ["2-3 hour event slot", "Basic room setup", "Welcome table and check-in support", "Event listing support"] },
    ...
    booking: [
        { title: "Morning Session", price: "From 1,200 kr.", items: ["08:00-12:00", "Coffee and tea station", "Meeting setup", "Quiet arrival window"] },
        { title: "Afternoon Session", price: "From 1,400 kr.", items: ["13:00-17:00", "Workshop tables", "Projector-ready wall", "Optional snack board"] },
        { title: "Full Day", price: "From 2,600 kr.", items: ["08:00-17:00", "Flexible room layout", "Breakout corners", "Food and drinks add-ons"] }
    ]
};
export const faqs = {
    Events: [
...
export const serviceCards = [
    {
        title: "Catering",
        href: "/catering",
        text: "Available on request. Seasonal, unfussy food and drinks for workshops, meetings and long-table evenings.",
        image: "/images/catering/catering-1.png"
    },
    {
        title: "Space Decoration & Event Styling",
        href: "/space-decoration-event-styling",
        text: "Available on request. Table settings, florals, candles and atmospheric details that make a room feel held.",
