...
export const socialLinks = [
    { href: "https://www.instagram.com/rorum_dk", label: "Instagram", icon: "instagram", brandColor: "#E4405F" },
    { href: "https://www.facebook.com/rorum2025", label: "Facebook", icon: "facebook", brandColor: "#1877F2" },
    { href: "https://linkedin.com", label: "LinkedIn", icon: "linkedin", brandColor: "#0A66C2" }
];
