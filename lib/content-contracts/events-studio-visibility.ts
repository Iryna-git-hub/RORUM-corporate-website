...
export const eventsStudioVisibilityContract: StudioVisibilityContract = {
  ...
  entries: [
    ...
    eventEntry({
      ...
      recommendedAction: "generateMetadata() prefers event.seo.title/.description/.ogImage, deriving fallback description text from event.formattedDescription and falling back to event.title/.image for the other fields.",
    ...
    eventEntry({
      ...
      studioTitle: "(3 legacy fields, all hidden)", studioDescription: "Superseded by formattedDescription/address+duration+arrival+ticketProviderInfo.",
      fieldType: "mixed", editorVisibleExpected: false, editorVisibleActual: false, requiredExpected: false, requiredActual: false,
      localized: true, requiredLanguages: [],
